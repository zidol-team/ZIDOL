import React, { useEffect, useState, PureComponent, createContext, useContext } from 'react';
 ...
 */
  ...
  useEffect(() => {
    ...
    fetch(URLS.ACHIEVEMENT_LIST, requestOptions)
      .then((res) => res.json())
      .then((res) => {
        console.log('res : ');
        console.log(res);
    ...
    // 전체 항목 갯수와 완료갯수 받는곳
    fetch(URLS.COUNT, requestOptions)
      .then((res2) => res2.json())
      .then((res2) => {
        console.log('res2 : ');
        console.log(res2);
